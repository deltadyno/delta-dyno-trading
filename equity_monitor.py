#!/usr/bin/env python3
"""
DeltaDyno - Market Equity Monitor

Entry point for running the market equity monitor.
Monitors open market orders and closes them based on
trailing stop loss, profit targets, and time-based rules.
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="DeltaDyno - Market Equity Monitor",
